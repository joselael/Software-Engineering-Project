...
router.post('/createproject', VerifyToken, function(req, res) {
    Project.create({
...
router.get('/accounts', VerifyAdmin, function (req, res) {
...
router.delete('/delete/:id', VerifyAdmin, function (req, res) {
...
router.put('/update/:id', VerifyAdmin, function (req, res) {
